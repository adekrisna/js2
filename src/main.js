...
const myAdmin = ['u31ef22df7f538df1d74dc7f756ef1a32'];

const myAssist = [];//Kosongin Aja Ini Gaguna Kntl

const myBot = ['u31ef22df7f538df1d74dc7f756ef1a32'];
var banList = [];//Banned list
var vx = {};var midnornama,pesane,kickhim;var waitMsg = "no";//DO NOT CHANGE THIS
var komenTL = "AutoLike by Kris\nhttp://line.me/ti/p/GkwfNjoPDH"; //Comment for timeline
var bcText = "Ini Spam,, Masuk Room Woy...!!!";
        ...
        if(operation.type == 11 && this.stateStatus.lockupdategroup == 1) {
          ...
          if(operation.type == 15 && this.stateStatus.bmsg == 1) {
         ...
         else
            {
             ...
             out.text = "Yah Kok Leave? Padahal Belom di Anuin .-."
           ...
           if(seq.contentType == 13 && this.sendBlacklist == 2 && isStaff(seq.from))
{
    ...
    await this._sendMessage(seq,'Udah Bossku~');
       ...
       if(txt == "response name"){
        ...
        {
         this._sendMessage(seq, 'Bubar Bubar Ada Anak yang suka mojok~');
         }
     }
        ...
        if(txt == 'tab:speed') {
            ...
            await this._sendMessage(seq,'Tunggu Broww....');
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
        ...
        if(txt == 'tab:creatorbot') {
           this._sendMessage(seq, 'My Creator Is Kris\nContact Line : http://line.me/ti/p/GkwfNjoPDH\n\n-тєαм Cyber Army вσт-');
           seq.contentType=13;
           seq.contentMetadata = { mid: 'u31ef22df7f538df1d74dc7f756ef1a32' };
           this._client.sendMessage(1, seq);
        }
...
//Tab:CreateGroup 100-NamaGrupnya/midkorban
        ...
        if(txt == 'tab:bye') {
           if(isAdmin(seq.from) || isStaff(seq.from)){
          let txt = await this._sendMessage(seq, 'Kami Dari Team Cyber Army Bot (TAB) Terima Kasih Atas Groupnya Dan Kami Izin Leave~');
